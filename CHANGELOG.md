...
- **Fix verificación inicial de Idealista**: Añadida espera de 10 segundos antes de comprobar DataDome en la primera carga del navegador, evitando falsos positivos del proceso de verificación automático de Idealista.
