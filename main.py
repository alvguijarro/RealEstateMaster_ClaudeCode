...
def start_service(service_name):
    global SCRAPER_PROCESS, ANALYZER_PROCESS
...
@app.route('/')
def index():
    return render_template('main.html', scraper_port=SCRAPER_PORT, analyzer_port=ANALYZER_PORT)
...
def stop_all():
    ...
    # Also find by ports to be safe?
    # For now, rely on process handles or manual cleanup
